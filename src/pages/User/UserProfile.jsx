      ...
      <main className="flex-1 p-6 lg:p-10 max-w-[1000px] mx-auto w-full">
        ...
        >
          ...
          <div className="flex flex-col-reverse md:flex-row justify-end items-center gap-4 mt-12 pt-6 border-t border-white/10">
            ...
            <button
              type="submit"
              className={` ${isLoading ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : ''} w-full md:w-auto px-8 h-12 rounded-xl bg-green-500 text-slate-900 font-bold hover:brightness-110 flex items-center justify-center gap-2 transition-all`}
            >

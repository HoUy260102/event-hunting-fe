...
TIER_SOLD_OUT: { 
    label: "Hết vé đợt này", 
    styles: "bg-red-50 text-red-600 border-red-200" // Đỏ nhạt hơn SOLD_OUT một chút để phân biệt
  },
  ON_SALE: { 
    label: "Đang mở bán", 
...
const TicketTypeStatusBadge = ({ status }) => {
...
export default TicketTypeStatusBadge;
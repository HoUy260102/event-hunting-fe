...
const RANK_NUMBERS = [
  ...
  >
    <path
      d="M16.125 0L0 51.45l4.159 6.15L22.326 0h-6.2zM24.879 0L6.566 58.05h38.668V75h5.764V52.5H14.52L31.081 0h-6.202z"
      fill="#2DC275"
    ></path>
    <path
      d="M17.948 50.25h33.05V23.775l-5.982 4.35V44.7H19.554l-1.606 5.55z"
      fill="#2DC275"
    ></path>
    <path
      d="M43.266 30.15l-6.421 4.35v8.175h6.42V30.15zM43.264 60.075h-6.42V75h6.42V60.075z"
      fill="#2DC275"
    ></path>
  </svg>,
  <svg
  ...
  >
    <path
      d="M2.049 5.775l29.133-.3L8.925 75h6.803L40.055 0H.865L2.05 5.775zM42.495.976L17.8 75h6.58L46.34 5.775l-3.845-4.8z"
      fill="#2DC275"
    ></path>
    <path
      d="M2.345 7.575l1.183 5.4h22.923l1.479-5.1-25.585-.3z"
      fill="#2DC275"
    ></path>
  </svg>,
  <svg
          ...
          {events.slice(0, 10).map((item, index) => (
            <SwiperSlide key={item.id} style={{ width: "256px" }}>
              <div
                key={item.id}
                onClick={() => {
                  navigate(`/event/${item?.id}/details`);
                }}
                className="flex relative items-end group cursor-pointer"
                style={{ width: "256px" }}
              >
                <div className="absolute -left-5 bottom-10 z-10 w-14 h-20 flex items-center justify-center text-gray-300 group-hover:text-green-500 transition-colors duration-300 pointer-events-none">
                  {RANK_NUMBERS[index] || (
                    <span className="text-4xl font-black">{index + 1}</span>
                  )}
                </div>

                <div className="pl-9 flex flex-col w-80 flex-shrink-0 group cursor-pointer">
                  <div className="relative w-68 aspect-[4/3] overflow-hidden rounded-2xl shadow-md border border-gray-100 flex-shrink-0">
                    <img
                      src={item?.posterUrl}
                      alt={item.name}
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3">
                      <button
                        type="button"
                        className="w-full py-1.5 bg-white text-black text-[11px] font-bold rounded-lg"
                      >
                        View Details
                      </button>
                    </div>

                    <div className="absolute top-2 left-2 bg-green-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow">
                      #{index + 1} Trending
                    </div>
                  </div>
                  ...
                  <div className="mt-2 w-full px-1">
                    <h3
                      className="font-bold text-gray-800 text-sm group-hover:text-green-600 transition-colors leading-snug"
                      style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 2,
